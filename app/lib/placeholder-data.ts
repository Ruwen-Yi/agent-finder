...
// assign each address an id
// assign each agent an subId
const agentsData = agents.map((agent) => ({
  ...agent,
  subId: nanoid(),
  address: { ...agent.address, id: nanoid() },
}))
...
export { agentsData as agents, clients, specializations, services, comments };
